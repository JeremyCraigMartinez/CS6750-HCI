...
\item
  ...
  \begin{itemize}
  \item
    The GPS (take Google Maps for example) has memory of all other driver's routes at one time. They can leverage this to make predictions based on \textemph{usual} traffic patterns.
  \item
...
For our given task \textemp{the pieces of the system} are comprised of
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.3]{figs/Venmo-home}
  \caption{Venmo home screen.}
  \label{fig::1}
\end{figure}
...
\begin{figure}[H]
  \centering
  \includegraphics[scale=0.3]{figs/Venmo-payment}
  \caption{Venmo home screen.}
  \label{fig::1}
\end{figure}
